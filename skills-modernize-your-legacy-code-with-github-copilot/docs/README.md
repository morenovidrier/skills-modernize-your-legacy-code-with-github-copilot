...
## Reglas de Negocio
- El saldo inicial de la cuenta es de 1000.00.
- No se permite debitar una cantidad que exceda el saldo actual.
- Las operaciones de crédito y débito se registran en el saldo de la cuenta.